      ...
      <div className="footer-wrapper">
        <footer>
          <div className="row-one">
            ...
            <form className="form-group-footer">
              <label htmlFor="email">
                Nyhedsbrev{" "}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {isInfoOpen && (
                <div className="info-boks">
                  <p>Hvad får jeg ud af at tilmelde mig nyhedsbrev?</p>
                  <ul>
                    <li>Tidlig invitation til events</li>
                    <li>Nyheder & kampagner</li>
                    <li>Rabatter & fordele</li>
                  </ul>
                  <p className="afmeld">
